<template>
  ...
  <el-row class="room-content">
    <el-col>
      <room-item class="room-item" v-for="room in rooms" :key="room.id" :room='room'
        @onRoomJoin='roomJoin'>
      </room-item>
    </el-col>
  </el-row>
  <el-row class="room-foot" :gutter="10">
    <el-col :span="12">
      <el-pagination :background='true' layout="prev, pager, next" :total="60" />
    </el-col>
    <el-col :span="4">
      <el-button class="room-btn" round size="large" type="primary" @click="roomListRefresh">刷新
      </el-button>
    </el-col>
    <el-col :span="4">
      <el-button class="room-btn" round size="large" type="primary" @click="roomQuickJoin">快速加入
      </el-button>
    </el-col>
    <el-col :span="4">
      <el-button class="room-btn" round size="large" type="primary" @click="roomCreate">
        创建房间
      </el-button>
    </el-col>
  </el-row>
